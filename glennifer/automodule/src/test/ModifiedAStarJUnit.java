...
public class ModifiedAStarJUnit {
    ...
    @Test
    public void test() {
        RobotPosition start = new RobotPosition((float) (-1.89 / 2), (float) (1.5 / 2), 0.0, 0.0F);
        RobotPosition end = new RobotPosition((float) (1.89 / 2), (float) (1.5 + 2.94 + 0.75), 0.0, 0.0F);
        ...
        RobotPosition cp1 = new RobotPosition(-0.5F, 1.5F, 0.0, 0.0F);
        RobotPosition cp2 = new RobotPosition(-0.3F, 2.0F, 0.0, 0.0F);
